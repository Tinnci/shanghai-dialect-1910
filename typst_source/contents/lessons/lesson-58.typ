...
#r("La", "拉") #r("s", "四") #r("kyi", "季") #r("taung-tsoong", "当中") #r("tshung", "春") #r("thien", "天") #r(
  "z",
  "是",
) #r("ting", "顶") #r("hau", "好") #r("kuh", "个") #r("thien-chi,", "天气，") #r("we-ts", "为之") #r(
  "nyung-nyung",
  "人人",
) #r("kuh", "个") #r("sung-thi", "身体") #r("ih-ding", "一定") #r("kauh-dzak", "觉着") #r(
  "man-saung-kwha,",
  "蛮爽快",
)#footnote[Very well.] #r("hwo-tsau", "花草") #r("zu-mok", "树木") #r("'a", "也") #r("z", "是") #r("tsang", "长") #r(
  "doo,",
  "大，",
) #r("fah-tsheh", "发出") #r("sing-sien", "新鲜") #r("kuh", "个") #r("hyang-chi", "香气") #r("le,", "来，") #r(
  "nyung-nyung",
  "人人",
) #r("mung-dzak", "闻着") #r("ts", "之") #r("meh,", "末，") #r("man", "蛮") #r(
  "khe-sing.",
  "开心。",
...
#r("Zak-zen", "若然") #r("kyau", "叫") #r("ih", "一") #r("tsak", "只") #r("zen", "船") #r("tau", "到") #r(
  ...
  "zeh-ke",
  "实盖",
) #r("lau,", "咾，") #r("yeu", "有") #r("too-hau", "多化") #r("nyung", "人") #r("pau-pe", "宝贝") #r(
  "di-kuh",
  "第个",
) #r("tshung", "春") #r("kyi", "季") #r("kuh", "个") #r("kwaung-iung,", "光阴，")
...
#r("zak-zen", "若然") #r("nyung", "人") #r("hwen-hyi", "欢喜") #r("tau", "到") #r("hyang-'au-deu", "乡下头") #r(
  ...
  "tshung-thien",
  "春天",
) #r("z", "是") #r("kung-ka", "更加") #r("hau,", "好，") #r("iung-we", "因为") #r("toong-thien", "冬天") #r(
  "z",
  "是",
) #r("iung-ke", "应该") #r("tang-lih-kuh", "打猎个") #r("z-'eu.", "时候。") #r("Fi-jung", "飞禽") #r(
  "tseu-seu",
  "走兽",
