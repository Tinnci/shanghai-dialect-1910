...
#exercise(95, "论到莫干山避暑", "LUNG TAU MOK-KOEN-SAN BI-SU")

#r("La", "拉") #r("zaung-kuh", "上个") #r("nyoeh,", "月") #r("ngoo", "我") #r("tah", "搭") #r("kyi-kuh", "几个") #r(
  "nga-kok",
  "外国",
) #r("sien-sang", "先生") #r("lau", "咾") #r("kyi-kuh", "几个") #r("Tsoong-kok", "中国") #r("bang-yeu,", "朋友") #r(
  "tau",
  "到",
  ...
  "khe",
  "开",
) #r("zen,", "船。") #r("tau", "到") #r("ming-tsau", "明朝") #r("'ang", "行") #r("koo", "过") #r(
  "Ka-zen,",
  "嘉善、",
  ...
  "tsung",
  "浸",
) #r("sah", "杀") #r("dau.", "稻。") #r("Yeu", "有") #r("kuh", "个") #r("meh,", "末") #r("yoong", "用") #r(
  "(7)",
  " ",
) #r("s-tsho,", "水车")#footnote[Irrigating wheel.] #r("tsho-tsheh", "车出") #r("s", "水") #r("le,", "来。") #r(
  "zen-r",
  "然而",
) #r("z", "是") #r("m-sa", "无啥") #r("doo", "大") #r("yoong-deu,", "用头，") #r("iung-we", "因为") #r(
  "hoo-lung-zen",
  "火轮船",
...
#r("Thing-tuh", "听得") #r("wo,", "话") #r("Zaung-he", "上海") #r("Dau-de", "道臺") #r("iau", "要") #r(
  "kyung-ts",
  "禁止",
  ...
  "ming-tsau",
  "明朝",
) #r("thien", "天") #r("wan", "还") #r("'veh-da", "勿大") #r("liang,", "亮。") #r("zen", "船") #r("i-kyung", "已经") #r(
  "tau",
  "到",
) #r("San-jau-boo", "三桥埠") #r("tse.", "哉。") #r("Nan-meh", "难末") #r("chuh-ts", "吃之") #r(
  "tsau-van,",
  "早饭，",
) #r("han-ts", "喊之") #r("thiau-foo", "挑夫") #r("lau", "咾") #r("jau-ts,", "轿子") #r("soong", "送") #r(
  "tau",
  "到",
  ...
  "tseu",
  "走",
) #r("tau", "到") #r("hau", "好") #r("tseu", "走") #r("kuh", "个") #r("di-faung", "地方") #r("meh", "末") #r(
  "tse",
  "再",
) #r("zoo", "坐") #r("jau-ts.", "轿子。") #r("Soo", "所") #r("tseu-koo-kuh", "走过个") #r("di-faung", "地方") #r(
  "(7)",
  " ",
) #r("tsok-yoen", "竹园")#footnote[Bamboo grove.] #r("z", "是") #r("ting", "顶") #r("too,", "多，") #r(
  "keh-lau",
  "盖咾",
) #r("kyung-ts", "景致") #r("'a", "也") #r("man", "蛮") #r("hau", "好") #r("khoen", "看") #r("kuh.", "个。") #r(
  "Tau-ts",
  "到之",
) #r("nyi", "伲") #r("dzu-kuh", "住个") #r("di-faung", "地方") #r("i-kyung", "已经") #r("zeh-ih", "十一") #r(
  "tien",
  "点",
) #r("tsoong", "钟") #r("tse.", "哉。") #r("Chuh-ts", "吃之") #r("van", "饭") #r("meh,", "末") #r(
  "tsheh-chi",
  "出去",
) #r("khoen-khoen", "看") #r("kyung-ts.", "景致。")
