...
#exercise(100, "论人做事体要有常心", "LUNG NYUNG TSOO Z-THI IAU YEU DZANG SING")

#r("Ngoo-nyi", "我伲") #r("Tsoong-kok", "中国") #r("nyung", "人") #r("tsoo", "做") #r("kauh-yang", "各样") #r(
  "z-thi",
  "事体",
  ...
  "tsoong",
  "衆",
) #r("nyung", "人") #r("hau,", "好") #r("dan-z", "但是") #r("tsoo", "做") #r("tau", "到") #r("pen", "半") #r(
  "taung-tsoong,",
  "当中",
) #r("sau-we", "稍为") #r("yeu", "有") #r("tien", "点") #r("van-nan", "烦难") #r("meh,", "末") #r("zieu", "就") #r(
  "iau",
  "要",
  ...
  "na-nung",
  "那能",
) #r("nyung", "人") #r("meh,", "末") #r("hau", "好") #r("tah", "搭") #r("kaung-koo", "江蜗") #r("pi", "比") #r(
  "nyi?",
  "呢",
) #r("Nen-tsoong", "內中") #r("yeu", "有") #r("kuh", "个") #r("yoen-koo,", "缘故") #r("ngoo", "我") #r("iau", "要") #r(
  "kaung",
  "讲",
) #r("peh", "拨") #r("tsu-we", "诸位") #r("thing-thing.", "听听。")
...
#r("Dzoong-zien", "从前") #r("yeu", "有") #r("ih-kuh", "一个") #r("siau", "小") #r("'auh-sang-ts,", "学生子") #r(
  ...
  "yang-suh,",
  "样式",
) #r("zieu", "就") #r("mung", "问") #r("yi", "伊") #r("we-sa", "为啥") #r("zeh-ke.", "实在") #r("Yi", "伊") #r(
  "we-deu",
  "回头",
) #r("wo,", "话") #r("\"'au", "“下") #r("li-pa", "礼拜") #r("'auh-daung", "学堂") #r("li", "里") #r("iau", "要") #r(
  "(5)",
  " ",
) #r("doo", "大") #r("khau,", "考")#footnote[Big examination.] #r("la", "拉") #r("khau", "考") #r("kuh", "个") #r(
  "z-'eu",
  "时候",
  ...
  "di-seu",
  "第首",
) #r("s", "诗") #r("meh,", "末") #r("dzang", "长") #r("lau", "咾") #r("van-nan,", "烦难") #r("soo-i", "所以") #r(
  "di-kuh",
  "第个",
) #r("saung-s", "赏赐") #r("ih-ding", "一定") #r("tuh-'dzak-kuh,", "得勿着个") #r("keh-lau", "盖咾") #r(
  "sing",
  "心",
...
#r("Nyang", "娘") #r("wo,", "话") #r("\"Noong", "“侬") #r("'veh", "勿") #r("iau", "要")  #r(
  ...
  "ih-ding",
  "一定",
) #r("khau-i", "可以") #r("tuh-dzak", "得着") #r("di-kuh", "第个") #r("saung-s-kuh.", "赏赐个。") #r("Noong", "侬") #r(
  "khoen-kyien",
  "看见",
) #r("i-tsak", "伊隻") #r("kaung-koo", "江蜗") #r("dzoong", "从") #r("ziang-kyak", "墙脚") #r("laung", "上") #r(
  "bo-tau",
  "扒到",
) #r("ziang-deu", "墙头") #r("ting", "顶") #r("laung.", "上。") #r("Yi", "伊") #r("'a", "也") #r("'veh", "不") #r(
  "tshung",
  "趁",
) #r("hoo-tsho,", "火车") #r("'veh", "也不") #r("tshung", "趁") #r("lung-zen,", "轮船") #r("dan-z", "但是") #r(
  "ih-boo",
  "一步",
) #r("ih-boo-kuh", "一步个") #r("bo,", "扒") #r("bo", "扒") #r("tau-ts", "到之") #r("ting", "顶") #r("laung", "上") #r(
  "lau",
  "咾",
  ...
  "tsu-we",
  "诸位",
) #r("dzing-boo", "巡捕") #r("dok", "读") #r("Tsoong-kok", "中国") #r("su", "书") #r("'a", "也") #r("iau", "要") #r(
  "zeh-ke",
  "实在",
) #r("meh", "末") #r("hau.", "好。")
