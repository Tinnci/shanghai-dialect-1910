...
#exercise(154, "开店个搭买客叙谈", "KHE TIEN-KUH TAH MA-KHAK DZUI-DAN.")

#r("A z khe-tien-kuh nyung. B z ma-khak.", "A 是开店个人 B 是买客")

#r("A", "A") #r("Tshing", "请") #r("sien-sang", "先生") #r("li-hyang", "里向") #r("zoo.", "坐。")
...
#r("A", "A") #r("Bi", "敝") #r("sing", "姓") #r("Waung.", "黄。") #r("Li-sien-sang", "李先生") #r("foo", "府") #r(
  "laung",
  "上",
) #r("la", "拉") #r("'a-li?", "那里？")

#r("B", "B") #r("Bi", "敝") #r("tshu", "处") #r("pung-di,", "本地，") #r("dan-z", "但是") #r("ngoo", "我") #r(
  "la",
  "拉",
...
#r("B", "B") #r("Hyoong-di", "兄弟") #r("dzoong", "从") #r("Pok-kyung", "北京") #r("tshung", "趁") #r(
  "hoo-tsho",
  "火车",
) #r("tau", "到") #r("Heu-kheu,", "汉口，") #r("nan-meh", "难末") #r("dzoong", "从") #r("Heu-kheu", "汉口") #r(
  "tshung",
  "趁",
) #r("hoo-lung-zen", "火轮船") #r("tau", "到") #r("Zaung-he.", "上海。")

#r("A", "A") #r("Li-sien-sang", "李先生") #r("iau", "要") #r("ban", "办") #r("tien", "点") #r("sa", "啥") #r(
  "kuh",
  "个",
) #r("hoo-suh?", "货色？")

#r("B", "B") #r("Ngoo", "我") #r("iau", "要") #r("ban", "办") #r("tien", "点") #r("yang-hoo", "洋货") #r(
  "poo-phih",
  "布疋",
...
#r("B", "B") #r("Keh-meh", "盖末") #r("tshing", "请") #r("lau-hyoong", "老兄") #r("tan", "担") #r("tien", "点") #r(
  "yang-ts",
  "样子",
) #r("le,", "来，") #r("peh", "拨") #r("ngoo", "我") #r("khoen", "看") #r("khoen.", "看。")
...
#r("B", "B") #r("Ih-phih", "一疋") #r("yeu", "有") #r("kyi", "几") #r("dzang?", "丈？")

#r("A", "A") #r("Iak-kwe", "约规") #r("ng", "五") #r("dzang.", "丈。")

#r("B", "B") #r("Ma", "卖") #r("sa-ka-dien?", "啥价钱？")

#r("A", "A") #r("San", "三") #r("liang", "两") #r("lok", "六") #r("dzien", "钱") #r("nyung-ts", "银子") #r(
  "ih",
  "一",
) #r("phih.", "疋。")
...
#r("A", "A") #r("Di-kuh", "第个") #r("z", "是") #r("gah-zeh", "价钱。") #r("Tshing", "请") #r("khoen", "看") #r(
  "hoo-suh,",
  "货色，",
) #r("yeu", "有") #r("hau", "好") #r("cheu", "快") #r("kuh.", "个。")
...
#r("A", "A") #r("Zak-zen", "若然") #r("hoo-suh", "货色") #r("'veh", "勿") #r("hau", "好") #r("khau-i", "可以") #r(
  "(5)",
  " ",
) #r("pau", "包") #r("the", "退") #r("pau", "包") #r("wan", "换") #r(
  "kuh.",
  "个。",
)#footnote[Surely it can be returned. (5)]

#r("B", "B") #r("Ngoo", "我") #r("yien-dze", "现在") #r("ding", "定") #r("ng-pak", "五百") #r("phih", "疋") #r(
  "lau",
  "老",
