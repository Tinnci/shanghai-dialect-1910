...
#exercise(49, "论轰脱自来火厂", "LUNG HOONG-THEH Z-LE-HOO TSHANG")

#r("Kyung-tsau", "今朝") #r("tsau-zung-deu", "早晨头") #r("iak-kwe", "约规") #r("kyeu", "九") #r(
  "tien-tsoong",
  "点钟",
) #r("kuh", "个") #r("z-'eu,", "时候，") #r("ngoo-nyi", "我伲") #r("la", "拉") #r("sia-z-kan", "写字间") #r(
  "li",
  "裏",
) #r("hweh-zen", "忽然") #r("thing-tuh", "听得") #r("ih-sang", "一声")#footnote[A big noise.] #r("juh-doo", "极大") #r(
  "kuh",
  "个",
) #r("sung-iung", "声音") #r("tsung-tuh", "震得")#footnote[Shook.] #r("mung", "门") #r("lau", "咾") #r(
  "tshaung",
  "窗",
...
#r("Nan-meh", "难末") #r("ngoo", "我") #r("nyi", "伲") #r("da-ka", "大家") #r("bau-tau", "跑到") #r(
  ...
  "toong-pok",
  "东北",
) #r("kauh-laung", "角上") #r("yeu", "有") #r("kyau-kwan", "交关") #r("huh", "黑") #r("ien.", "烟。") #r(
  "Nyi",
  "我伲",
...
#r("ngoo", "我") #r("nyi", "伲") #r("kyau", "叫") #r("nyung", "人") #r("tan", "担") #r("yi-la", "伊拉") #r(
  ...
  "nyung,",
  "人，",
) #r("s-tuh", "使得") #r("nyung", "人") #r("sing-li", "心裏")#footnote[Distressed in mind.] #r("nan-koo", "难过") #r(
  "lau",
  "咾",
) #r("'veh", "勿") #r("iau", "要") #r("khoen-kyien", "看见") #r("yi-la", "伊拉") #r("kuh", "个") #r(
  "s-seu.",
  "尸首。",
)#footnote[Corpse.]
