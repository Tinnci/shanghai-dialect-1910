...
#r("Yeu", "有") #r("ih-kuh", "一个") #r("(9)", " ") #r("tsih-nyih,", "节日，")#footnote[A festival day.] #r(
  ...
  "nga-khoo",
  "外科",
) #r("laung-tsoong", "郎中") #r("zieu", "就") #r("tsauh", "捉") #r("yi", "伊") #r("tsen-chi", "转去") #r(
  "lau",
  "咾",
) #r("peh", "拨") #r("yi", "伊") #r("chuh.", "吃。")

#r("'Veh", "勿") #r("too", "多") #r("kyi-nyih", "几日") #r("i-'eu,", "以后，") #r("di-tsak", "第隻") #r("keu", "狗") #r(
  "tsaung",
  "奘",
...
#r("Yeu", "有") #r("ih-nyih", "一日") #r("di-kuh", "第个") #r("nga-khoo", "外科") #r("laung-tsoong", "郎中") #r(
  "tau",
  "到",
  ...
  "tih",
  "跌",
) #r("la", "拉") #r("ih-tsak", "一隻") #r("ien-thah", "烟榻") #r("laung", "上") #r("lau", "呢") #r(
  "kwhung-dzak-tse.",
  "睏着哉。",
) #r("Yi", "伊") #r("kwhung-ts", "睏之") #r("koo-po", "个把") #r("tsoong-deu", "钟头") #r("meh,", "末，") #r(
  "thih",
  "贴",
) #r("kah-pih", "隔壁") #r("dzak-sang-deu-li", "著生头裡") #r("hoo-dzak", "火焑") #r("tse,", "哉。") #r(
  "dan-z",
  "但是",
) #r("yi", "伊") #r("hau", "好") #r("kwhung", "睏") #r("le-si,", "来死，") #r("ih-ngan", "一颜") #r("'veh", "勿") #r(
  "kauh-dzak",
  "觉着",
) #r("lau,", "咾") #r("sung", "身") #r("'a", "也") #r("'veh", "勿") #r("fan.", "翻。")

#r("Nan-meh", "难末") #r("yung-kwhe", "幸亏") #r("di-tsak", "第隻") #r("keu", "狗") #r("hyau-tuh", "晓得") #r(
  "hoo",
  "火",
) #r("z", "是") #r("we-hyien-kuh,", "危险个，") #r("soo-i", "所以") #r("zieu", "就") #r("te", "对") #r("yi", "伊") #r(
  "kyau",
  "叫",
  ...
  "keh-lau",
  "盖咾",
) #r("'veh-zung", "勿会") #r("seh-theh", "失脱") #r("yi-kuh", "伊个") #r("sing-ming.", "性命。") #r("Ziang", "像") #r(
  "di-kuh",
  "第个",
) #r("nung-kuh", "能个") #r("z-thi,", "事體，") #r("'a", "也") #r("yeu", "有") #r("ih-kyui", "一句") #r(
  "dzok-nyui",
  "俗语",
) #r("wo,", "话：") #r("\"Auh", "“恶") #r("yeu", "有") #r("auh", "恶") #r("pau,", "报，") #r("zen", "善") #r(
  "yeu",
  "有",
) #r("zen", "善") #r("pau,", "报；") #r("zak-zen", "若然") #r("'veh", "勿") #r("pau,", "报，") #r("z-'eu", "时候") #r(
  "'veh",
  "勿",
) #r("tau.\"", "到。”")
