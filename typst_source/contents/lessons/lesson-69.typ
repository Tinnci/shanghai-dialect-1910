...
#r("LUNG", "论") #r("KHOEN", "看") #r("(1)", " ") #r("PAU-KUH", "报个")#footnote[Magazine, paper.] #r(
  ...
  "iau",
  "要",
) #r("khoen", "看") #r("sing-vung-ts,", "新闻纸，") #r("nan-meh", "难末") #r("khau-i", "可以") #r(
  "hyau-tuh",
  "晓得",
) #r("kuh.", "个。")
...
#r("Soo-i", "所以") #r("kok-doo", "国度") #r("(3)", " ") #r("yoeh", "越") #r(
  ...
  "Khoen",
  "看",
) #r("sing-vung-ts", "新闻纸") #r("'veh-dan", "勿但") #r("nung-keu", "能够") #r("hyau-tuh", "晓得") #r(
  "z-thi,",
  "事体，",
...
#r("Zak-zen", "若然") #r("nyi", "伲") #r("tung", "登") #r("la", "拉") #r("ok-li", "屋里") #r("'veh", "勿") #r(
  "khoen",
  "看",
) #r("sing-vung-ts,", "新闻纸，") #r("keh-meh", "盖末") #r("nyi", "伲") #r("'veh", "勿") #r("hyau-tuh", "晓得") #r(
  "s-ka",
  "世界",
) #r("laung", "上") #r("yeu", "有") #r("sa,", "啥，") #r("hau-ziang", "好像") #r("hah-ts,", "瞎子") #r(
  "loong-bang",
  "聋瞆",
) #r("ih-yang.", "一样。")
...
#r("Ngoo", "我") #r("thing-kyien", "看见") #r("bih", "别") #r("nyung", "人") #r("wo", "话") #r("(5)", " ") #r(
  ...
  "taung-tsoong",
  "当中",
) #r("ih-kuh-nyoeh-kuh", "一个月个") #r("koong-foo.", "功夫。")

#r("Zak-zen", "若然") #r("m-meh", "无没") #r("sing-vung-ts", "新闻纸") #r("khoen", "看") #r("meh,", "末") #r(
  "z'au",
  "是毫",
  ...
  "iung",
  "印",
) #r("sing-vung-ts", "新闻纸") #r("lau,", "咾") #r("ma", "买") #r("la", "拉") #r("tah-khak.", "搭客。") #r(
  "Ih",
  "一",
) #r("nyih", "日") #r("khau-i", "可以") #r("tsheh", "出") #r("kyi", "几") #r("tshien", "千") #r("tsang.", "张。")

#r("Tsau", "照") #r("zeh-ke", "实盖") #r("khoen-chi-le,", "看起来") #r("nga-kok-nyung", "外国人") #r("z", "是") #r(
  "khoen-dzoong",
  "看重",
) #r("sing-vung-ts,", "新报纸，") #r("soo-i", "所以") #r("yi-la-kuh", "伊拉个") #r("'auh-vung", "学问") #r(
  "nyih-too",
  "日多",
) #r("tsang-doo", "长大大") #r("lau,", "咾") #r("kok-doo", "国度") #r("we-tuh", "会得") #r("hyung-waung", "兴旺") #r(
  "yan.",
  "也。",
)
