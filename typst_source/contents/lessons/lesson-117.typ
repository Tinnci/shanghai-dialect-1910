...
#r("Zauh-nyih", "昨日") #r("tsau-zung,", "早晨，") #r("ngoo", "我") #r("tau", "到") #r("(5)", " ") #r("sing", "新") #r(
  ...
  "khoen,",
  "看，",
) #r("khoen-kyien", "看见") #r("yeu", "有") #r("liang-kuh", "两个") #r("nga-kok-nyung,", "外国人，") #r(
  "ji-ts",
  "骑之",
) #r("mo", "马") #r("lau", "咾") #r("kwha-le-si-kuh", "快来死个") #r("le.", "来。")

#r("Nan-meh", "难末") #r("ngoo", "我") #r("lien-maung", "连忙") #r("tseu", "走") #r("la", "拉") #r(
  "pien-deu-kuh",
  "边头个",
) #r("nyi", "泥") #r("loo", "路") #r("laung", "上") #r("nyang", "让") #r("yi-la,", "伊拉，") #r("iung-we", "因为") #r(
  "ngoo",
  "我",
  ...
  "tsak",
  "只",
) #r("mo", "马") #r("thih-tsung", "贴准") #r("la", "拉") #r("ngoo", "我") #r("pe", "背") #r("'eu", "后") #r(
  "le,",
  "来，",
) #r("tsuh", "只") #r("the-pan", "推拨") #r("tuh", "得") #r("nyi", "二") #r("san", "三") #r("tsak", "尺") #r(
  "loo.",
  "路。",
) #r("Ngoo", "我") #r("le-'veh-ji", "来勿及") #r("nyang", "让") #r("yi-la", "伊拉") #r("tse.", "哉。") #r(
  "Nan-meh",
  "难末",
) #r("na-nung.", "哪能。") #r("'A-li", "哪里") #r("hyau-tuh", "晓得") #r("yeu-pien-kuh", "右边个") #r(
  "nga-kok-nyung,",
  "外国人，",
  ...
  "mo",
  "马",
) #r("meh,", "末") #r("ih-dzuh", "一直") #r("dzau", "朝") #r("pok", "北") #r("bau,", "跑，") #r("'veh", "勿") #r(
  "hyau-tuh",
  "晓得",
) #r("bau-ts", "跑之") #r("'a-li", "哪里") #r("chi.", "去。") #r("'Eu-le", "后来") #r("di-kuh", "第个") #r(
  "nyung",
  "人",
) #r("dzoong", "从") #r("pang-li", "浜里") #r("lok-chi-le,", "碌起来，") #r("tau", "到") #r("bih-tshu", "别处") #r(
  "chi",
  "去",
) #r("zing", "净") #r("koen-zing.", "干净。") #r("Tah", "搭") #r("yi", "伊") #r("ih-dau", "一淘") #r("la", "拉") #r(
  "kuh",
  "个",
) #r("nyung", "人") #r("meh,", "末") #r("theh", "对") #r("yi", "伊") #r("chi", "去") #r("zing", "寻") #r(
  "ih-tsak",
  "一匹",
) #r("mo", "马") #r("tse.", "哉。") #r("Na", "侬") #r("siang", "Siang") #r("zeh-ke", "实盖") #r(
  "yang-suh-kuh",
  "样式个",
) #r("z-thi,", "事体，") #r("chi", "岂") #r("'veh-z", "勿是") #r("we-hyien", "危险") #r("va.", "啘。")
