...
#exercise(72, "论鸦片烟", "LUNG A-PHIEN-IEN")

#r("La", "拉") #r("di-jeu", "地球") #r("laung", "上") #r("kauh-kok", "各国") #r("kuh", "个") #r("pak-sing,", "百姓") #r(
  "tsho-'veh-too",
  "差勿多",
) #r("zen", "全") #r("chuh", "吃") #r("ien-kuh,", "烟个") #r("dan-z", "但是") #r("'veh", "勿") #r("chuh", "吃") #r(
  "ih-yang",
  "一样",
...
#r("Ngoo", "我") #r("thing-tuh", "听得") #r("too-hau", "多化") #r("yeu", "有") #r("pung-z", "本事") #r("kuh", "个") #r(
  "nyung",
  "人",
) #r("wo,", "话") #r("ien", "烟") #r("chuh-'veh", "吃勿") #r("tuh-kuh.", "得个。") #r("Ngoo", "我") #r(
  "siang",
  "想",
  ...
  "doo",
  "大",
) #r("'auh-sang-ts", "学生子") #r("la", "拉") #r("chuh", "吃") #r("hyang-ien,", "香烟") #r("'eu-le", "后来") #r(
  "yi",
  "伊",
) #r("peh", "拨") #r("ngoo", "我") #r("hoo", "呼") #r("ih-kheu.", "一口。") #r("Ngoo", "我") #r("hoo-ts", "呼之") #r(
  "meh,",
  "末",
...
#r("Dan-z", "但是") #r("la", "拉") #r("ien", "烟") #r("taung-tsoong,", "当中") #r("ting", "顶") #r(
  "'veh-hau-kuh",
  "勿好个",
  ...
  "lau-bing-kuh",
  "痨病个",
) #r("nyung", "人") #r("ih-yang", "一样") #r("tse.", "哉。")

#r("Yien-dze", "现在") #r("Tsoong-kok", "中国") #r("pak-sing,", "百姓") #r("doo", "大") #r("ih-pen", "一半") #r(
  "z",
  "是",
  ...
  "soo-i",
  "所以",
) #r("a-phien-ien", "鸦片烟") #r("meh,", "末") #r("ih-nyih", "一日") #r("jang", "强") #r("ih-nyih", "一日") #r(
  "lau,",
  "咾",
) #r("chuh", "吃") #r("kuh", "个") #r("nyung", "人") #r("meh,", "末") #r("kung-ka", "更加") #r("too", "多") #r(
  "tse.",
  "哉。",
)
...
#r("Yi-la", "伊拉") #r("wo,", "话") #r("chuh-ts", "吃之") #r("meh,", "末") #r("s-tuh", "使得") #r("nyung", "人") #r(
  ...
  "hau",
  "好",
) #r("too", "多") #r("ka-ien", "戒烟") #r("yak,", "药") #r("dan-z", "但是") #r("tsoong", "终") #r("iau", "要") #r(
  "liang",
  "两",
...
#r("Zien-deu", "前头") #r("chi", "起") #r("yeu", "有") #r("too-hau", "多化") #r("(3)", " ") #r("s", "施") #r(
  ...
  "ka-ien",
  "戒烟",
) #r("yak,", "药") #r("ka-dien", "价钱") #r("meh,", "末") #r("man-jang", "蛮强") #r("kuh,", "个") #r(
  "dan-z",
  "但是",
) #r("nyung", "人") #r("chuh-ts", "吃之") #r("meh,", "末") #r("iau", "要") #r("saung", "伤") #r("sung-thi,", "身体") #r(
  "(4)",
  " ",
) #r("zung-ts-yui", "甚至于")#footnote[So that.] #r("yeu", "有") #r("nyung", "人") #r("chuh-ts", "吃之") #r(
  "lau,",
  "咾",
) #r("saung", "伤") #r("sing-ming.", "性命。")

#r("We-ts", "为之") #r("di-kuh", "第个") #r("yoen-koo,", "缘故") #r("yeu", "有") #r("too-hau", "多化") #r(
  "chuh",
  "吃",
) #r("a-phien-ien-kuh", "鸦片烟个") #r("nyung", "人") #r("'veh-ke", "勿敢") #r("ka-ien;", "戒烟") #r(
  "yi-la",
  "伊拉",
) #r("siang", "想") #r("z", "是") #r("ka-'veh-theh-kuh.", "戒勿脱个。") #r("Dan-z", "但是") #r("yien-dze", "现在") #r(
  "yeu",
  "有",
...
#r("La", "拉") #r("Kwaung-dzu", "光绪") #r("san-seh-nyi", "三十二") #r("nyien,", "年，") #r("Tsoong-kok", "中国") #r(
  "chi-deu",
  "起头",
) #r("kyung", "禁") #r("a-phien-ien,", "鸦片烟，") #r("soo-i", "所以") #r("yien-dze", "现在") #r(
  "kauh-tshu-kuh",
  "各处个",
) #r("a-phien-ien", "鸦片烟") #r("kan,", "间") #r("kwan-theh-ts", "关脱之") #r("ih-doo-pen", "一大一半") #r(
  "tse.",
  "哉。",
...
#r("La", "拉") #r("Tsoong-kok-kuh", "中国个") #r("Tsung", "正") #r("nyoeh", "月") #r("zeh-ih", "十一") #r(
  ...
  "We-Tsoong-van-tien",
  "匯中饭店",
) #r("leu-laung,", "楼上") #r("saung-liang", "商量") #r("kyung-theh", "禁脱") #r("a-phien-ien.", "鸦片烟。") #r(
  "Di-kuh",
  "第个",
) #r("z-thi,", "事体") #r("ngoo", "我") #r("siang", "想") #r("na", "哪") #r("la", "拉") #r("sing-vung-ts", "新闻纸") #r(
  "laung",
  "上",
) #r("i-kyung", "已经") #r("khoen-kyien-hyih", "看见歇") #r("tse,", "哉") #r("soo-i", "所以") #r("ngoo", "我") #r(
  "pih-koo",
  "必过",
) #r("too-wo", "多话") #r("tse.", "哉。")
