...
#exercise(151, "论热天第二段", "LUNG NYIH THIEN, DI-NYI-DOEN.")
...
#r("Ngoo", "我") #r("la", "拉") #r("maung", "梦") #r("li", "里") #r("tseu", "走") #r("tau", "到") #r("ih", "一") #r(
  ...
  "ngoo",
  "我",
) #r("kyung-koo", "经过") #r("kyi-kuh", "几个") #r("doo", "大") #r("zu-ling,", "树林，") #r("zieu", "就") #r(
  "tseu",
  "走",
) #r("tau", "到") #r("ih-khwe", "一块") #r("bing", "平") #r("di", "地") #r("laung,", "上，") #r("la", "拉") #r(
  "i-deu",
  "伊头",
  ...
  "yi",
  "又",
) #r("khoen-kyien", "看见") #r("ih-zoo", "一座") #r("zak", "石") #r("pa-leu.", "牌楼。")
...
#r("Hyih-ts", "歇之") #r("ih-hyih", "一歇") #r("ngoo", "我") #r("ban", "逴") #r("san,", "山") #r("koo", "过") #r(
  ...
  "yeu",
  "有",
) #r("ih-kuh", "一个") #r("dzien-ngan", "泉眼") #r("li", "里") #r("kuh", "个") #r("s,", "水，") #r("z", "是") #r(
  "(13)",
  " ",
) #r("pih-lok", "碧绿") #r("sang-tshing-kuh.", "生青个。")#footnote[Green, like the jade. (13)] #r("Ngoo", "我") #r(
  "'eu-'au-chi",
  "匾下去",
) #r("zing-zing", "净净") #r("seu", "手") #r("hweh-zen", "忽然") #r("thing-kyien", "看见") #r(
  "phak-phak-kuh",
  "拍拍个",
  ...
  "zu-'au-ts",
  "树丫枝",
) #r("laung,", "上") #r("'auh", "学") #r("kauh-yang-kuh", "各种个") #r("tiau-kyau.", "禽叫。")

#r("Ngoo", "我") #r("la", "拉") #r("di-kuh", "第个") #r("zung-kwaung,", "辰光") #r("zieu", "就") #r("siang", "想") #r(
  "tau",
  "到",
) #r("zau-veh", "造物") #r("Tsu", "主") #r("tshaung-zau", "创造") #r("thien-di", "天地") #r("van-veh-kuh", "万物个") #r(
  "'au-miau.",
  "奥妙。",
  ...
  "laung.",
  "上。",
) #r("Ngoo-kuh", "我个") #r("bang-yeu", "朋友") #r("meh,", "末") #r("lih-la", "立拉") #r("pien-deu.", "边头。") #r(
  "Ngoo",
  "我",
) #r("kwhung", "睏") #r("kuh", "个") #r("z-'eu", "时候") #r("z", "是") #r("liang", "两") #r(
  "tien-tsoong,",
  "点钟，",
) #r("yien-dze", "现在") #r("z", "是") #r("lok", "六") #r("tien-tsoong", "点钟") #r("koo", "过") #r(
  "zeh-fung",
  "十分",
) #r("tse.", "者。") #r("'E!", "咳！") #r("Kwaung-iung", "光阴") #r("zu", "如") #r("tshien,", "箭，") #r(
  "zeh",
  "日",
) #r("yoeh", "月") #r("zu", "如") #r("soo.", "梭。") #r("Di-kyui", "第句") #r("seh-wo", "说话") #r("z", "是") #r(
  "ih-ngan",
  "一颜",
) #r("'veh", "勿") #r("tsho-kuh.", "差个。")
