...
#exercise(138, "论老爹搭之孙子", "LUNG (5) LAU-TIA TAH-TS (6) SUNG-TS.")

#r("Dzoong-zien", "从前") #r("yeu", "有") #r("ih-kuh", "一个") #r("lau-nyien", "老年") #r("nyung,", "人，") #r(
  "tah-ts",
  "搭之",
) #r("yi-kuh", "伊个") #r("nyi-ts", "儿子") #r("ih-dau", "一淘") #r("dzu-la.", "住拉。") #r("We-ts", "为之") #r(
  "yi",
  "伊",
  ...
  "chuh.",
  "吃。",
) #r("Nau", "拿") #r("chuh-jok", "吃局") #r("pa-la", "摆拉") #r("jeu-kuh", "旧个") #r("wen-li,", "碗里，") #r(
  "r-tshia",
  "而且",
) #r("'a", "也") #r("'veh", "勿") #r("peh", "拨") #r("yi", "伊") #r("chuh", "吃") #r("pau.", "饱。") #r(
  "Di-kuh",
  "第个",
...
#r("Yeu", "有") #r("ih-nyih", "一日") #r("yi-kuh", "伊个") #r("seu", "手") #r("fah-teu", "发行") #r("lau,", "咾，") #r(
  "ih-tsak",
  "一隻",
) #r("wen", "碗") #r("nyah-'veh-lau,", "捏勿牢") #r("lauh", "落") #r("la", "拉") #r("di-laung", "地上") #r(
  "lau",
  "咾",
  ...
  "jang-kuh",
  "强个",
) #r("mok-wen", "木碗") #r("peh", "拨") #r("yi", "伊") #r("yoong.", "用。") #r("Yeu", "有") #r("ih-nyih,", "一日，") #r(
  "yi",
  "伊",
) #r("zoo", "坐") #r("la", "拉") #r("thih-tsau", "铁灶") #r("个后面", " ") #r("'eu-mien", " ") #r(
  "kauh-lauh",
  "角落",
) #r("li.", "里。") #r("Yi-kuh", "伊个") #r("siau", "小") #r("sung-ts", "孙子") #r("zoo", "坐") #r("la", "拉") #r(
  "yi-kuh",
  "伊个",
  ...
  "mok-zau",
  "木槽",
) #r("sa", "啥") #r("yoong-deu.\"", "用头？”") #r("Siau-noen", "小囝") #r("wo,", "话：") #r("\"Ngoo", "“我") #r(
  "tsang-doo-ts",
  "长大之后",
  ...
  "yi-la.",
  "伊拉。",
) #r("Dzoong", "从") #r("di-kuh", "第个") #r("i-'eu", "以后") #r("yi-la", "伊拉") #r("nyang", "让") #r(
  "lau-nyien",
  "老年",
) #r("nyung", "人") #r("zoo", "坐") #r("la", "拉") #r("de-ts", "檯子") #r("laung", "上") #r("ih-dau", "一淘") #r(
  "chuh",
  "吃",
) #r("van.", "饭。") #r("Soe-zen", "虽然") #r("yeu", "有") #r("tsok-van", "粥饭") #r("pheh-tsheh-le", "泼出来") #r(
  "la",
  "拉",
) #r("de-ts", "檯子") #r("laung", "上") #r("lau", "咾") #r("i-zaung", "衣裳") #r("laung,", "上，") #r(
  "yi-la",
  "伊拉",
) #r("z", "是") #r("'veh", "勿") #r("wo", "话") #r("sa", "啥") #r("tse.", "者。")
